...
from common.variables import MAX_CONNECTIONS, WHITHER, SENDER, \
    PRESENCE, ACTION, USER, TIME, MESSAGE, MESSAGE_TEXT, RESPONSE_200, \
...
class MessageProcessor(threading.Thread):
    ...
    def process_message(self, message):
        ...
        if message[WHITHER] in self.names \
                and self.names[message[WHITHER]] in self.listen_sockets:
            try:
