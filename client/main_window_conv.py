...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        MainClientWindow.resize(683, 681)
        MainClientWindow.setMinimumSize(QtCore.QSize(650, 450))
        ...
        self.label_contacts.setGeometry(QtCore.QRect(40, 10, 151, 16))
        font = QtGui.QFont()
        ...
        self.btn_add_contact.setGeometry(QtCore.QRect(30, 540, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.btn_remove_contact.setGeometry(QtCore.QRect(30, 580, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_history.setGeometry(QtCore.QRect(320, 10, 171, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.text_message.setGeometry(QtCore.QRect(310, 450, 341, 71))
        self.text_message.setObjectName("text_message")
        self.label_new_message = QtWidgets.QLabel(self.centralwidget)
        self.label_new_message.setGeometry(QtCore.QRect(320, 430, 211, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.list_contacts.setGeometry(QtCore.QRect(30, 30, 251, 491))
        self.list_contacts.setObjectName("list_contacts")
        self.list_messages = QtWidgets.QListView(self.centralwidget)
        self.list_messages.setGeometry(QtCore.QRect(310, 30, 341, 381))
        self.list_messages.setObjectName("list_messages")
        self.btn_send = QtWidgets.QPushButton(self.centralwidget)
        self.btn_send.setGeometry(QtCore.QRect(470, 530, 181, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btn_send.setFont(font)
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(540, 590, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Чат Программа. Месинджер клиента"))
        ...
        self.label_new_message.setText(_translate("MainClientWindow", "Напишите своё сообщение:"))
        self.btn_send.setText(_translate("MainClientWindow", "Отправить сообщение"))
        self.btn_clear.setText(_translate("MainClientWindow", " Удалить\n"
"сообщение"))
