...
class ClientMainWindow(QMainWindow):
    ...
    def set_disabled_input(self):
        ...
        # Поле ввода и кнопка отправки (неактивных) до выбора получателя.
    ...
    def history_list_update(self):
        ...
        # Если модель не создана, создаём.
    ...
    def select_active_user(self):
        """
        Функция обработчик дабл-клика по контакту
        :return:
        """
        # Выбранный пользователем (дабл-клик) находится в выделеном элементе в QListView
    ...
    def add_contact_action(self, item):
        """
        Функция - обработчик добавлений (сообщает серверу).
